 ...
 * 
 * private static Workbook book; private static Sheet sheet;
 * 
 * public static Object[][] getTestData(String sheetName) { Object data[][] =
 * null;
 * 
 * try { FileInputStream ip = new
 * FileInputStream(Constants.TEST_DATA_SHEET_PATH); book =
 ...
 * FrameworkException("Excel file is not found or incorrect..."); } catch
