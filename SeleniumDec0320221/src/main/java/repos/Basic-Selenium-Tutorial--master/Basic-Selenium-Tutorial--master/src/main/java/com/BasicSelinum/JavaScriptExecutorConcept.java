 ...
 * @since 1.0
 */
public final class JavaScriptExecutorConcept {
	...
	public static void main(String[] args) throws IOException {
		...
		//take screenshot: Take screenshot and store as a file format
		File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		// now copy the screenshot to desired location using copyFile //method
		FileUtils.copyFile(src, new File("C:\\Users\\HASSEN\\workspace\\BasicSelinum_Tutorail_Suite\\Pass\\element.png"));
