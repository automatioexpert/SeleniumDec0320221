 ...
 * 
 * isDisplayed() is the method used to verify presence of a web element within the webpage. The method returns a “true” value if the specified
 * web element is present on the web page and a “false” value if the web element is not present on the web page.
 * 
 ...
 * 
 */
public final class CheckVisibilityElement {

	public static WebDriver driver = null;

	/**
	 * @author Hassen Nov 2, 2022
	 * @param args
	 */
