...
<body>
	<header
		...
		<a class="navbar-brand col-md-0 px-4" href="#">User Contact
			Management App</a>
			...
			<nav id="sidebarMenu"
				...
				<center>
					<div class="position-sticky pt-3">
						<ul class="list-group">
							<li><a type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#SignUpmodal">Add New User</a>
							</li>
						</ul>
					</div>
				</center>
						...
						<tbody>
							<c:forEach var="userDetails" items="${listOfContacts}" >
								<tr>
									...
									<td><c:out value="${userDetails.userMobileNo}" /></td>
								...
								<form action="<%=request.getContextPath()%>/contactApp?action=insert" target="_self" method="post">
									...
									<div class="ps-3 pe-3 pt-3">
										<input type="email" class="form-control" id="email"
											placeholder="User Email Id" name="email">
									</div>
									<div class="ps-3 pe-3 pt-3">
										<input type="text" class="form-control" id="country"
											placeholder="User Country" name="userCountry">
									</div>
