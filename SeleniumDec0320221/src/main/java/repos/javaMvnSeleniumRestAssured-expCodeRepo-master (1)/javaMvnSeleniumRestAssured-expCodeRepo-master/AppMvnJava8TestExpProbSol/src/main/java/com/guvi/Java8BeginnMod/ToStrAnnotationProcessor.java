...
public class ToStrAnnotationProcessor extends AbstractProcessor
{
                          ...
                          RoundEnvironment roundEnv)
   {
      ...
      {
         Set<? extends Element> elements=roundEnv.getElementsAnnotatedWith((Class<? extends Annotation>) ToStrAnnotationProcessor.class);
         ...
         while (iter.hasNext())
         {
            ...
            {
               error("@TestToStrData must prefix a class -- "+element+
                     " is not a class");
               continue;
            }
