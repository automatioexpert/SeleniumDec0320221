...
@Epic("Regression")
@Feature(" Test Add/Edit Carousel and Delete an item from them")
public class TC005_VerifyAddEditDeleteCarouselFeature extends GetDriver {
	...
	@Description("Checking Add a new carousel")
	 @Test(priority=0)
	...
	@Description("Checking Edit earlier created carousel")
	 @Test(priority=1)
	...
	@Description(" Checking Delete earlier added/edited carousel")
	 @Test(priority=2)
